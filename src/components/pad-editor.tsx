...
/**
 * Editor pane: a slim toolbar with Save + autosave toggle, a path breadcrumb
 * for the active file, and the Sandpack editor itself. Tabs are off — the
 * file tree is the source of truth for what's open.
 */
