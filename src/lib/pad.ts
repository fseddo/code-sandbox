...
export function savePad(id: string, files: SandpackFiles): void {
...
export function clearPad(id: string): void {
  if (typeof window === "undefined") return;
  try {
...
export function listPads(): PadSummary[] {
  if (typeof window === "undefined") return [];
